...
val ecosystem = Slide(
    ...
    wordCloud(state, 4, "KotlinX Serialization") { top(35.percent); left(2.percent) }
    wordCloud(state, 5, "SQLDelight") { bottom(40.percent); left(4.percent) }
    ...
    wordCloud(state, 7, "Kodein") { bottom(38.percent); right(15.percent) }
    ...
    wordCloud(state, 10, "Canard") { bottom(20.percent); left(3.percent) }
