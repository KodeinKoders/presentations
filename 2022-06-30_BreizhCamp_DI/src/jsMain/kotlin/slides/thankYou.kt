...
val thankYou = Slide(
    ...
    Div({
        ...
        Div({
            ...
            H3 {
                A(href = "https://github.com/kosi-libs/Kodein", {
                    target(ATarget.Blank)
                }) {
                    Span({ style { fontWeight(300) } }) { Text("https://github.com/") }
                    Br()
                    Span({ style { fontWeight(600) } }) { Text("kosi-libs/Kodein") }
                }
            }
            ...
            A(href = "https://kodeinkoders.github.io/presentations/2022-06-30_BreizhCamp_DI", {
                css {
                    paddingTop(2.em)
                    fontWeight(200)
                }
            }) {
                Text("https://kodeinkoders.github.io/presentations/2022-06-30_BreizhCamp_DI")
            }
        }
    }
}