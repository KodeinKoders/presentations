...
val thankYou = Slide(
    ...
    Div({
        ...
        Div({
            ...
            A(href = "https://kodeinkoders.github.io/presentations/2022-04-11-GDGAlps-KMM-Ecosystem", {
                css {
                    paddingTop(2.em)
                    fontWeight(200)
                }
                ...
                Br {}
                Text("2022-04-11-GDGAlps-KMM-Ecosystem")
            }
            ...
            Div({
                ...
                Img(src = "img/presentation-link.png") {
                    css {
                        height(5.em)
                    }
                }
